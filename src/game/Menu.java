...
public class Menu {
	int cenario = -1; // ESSA VARIAVEL INDICA EM QUE CENÁRIO ESTAMOS, -1(NENHUM CENÁRIO) (0,1,2,3...N)
						// OUTROS CENÁRIOS
	int itemSelecionado = 0; // ESSA VARIAVEL SERVIRÁ PARA INDICAR QUAL ITEM QUE ESTÁ SELECIONADO (o atual é
								// zero que é o primeiro item do menu)
	String itens[]; // aqui vamos guardar os itens do nosso menu (jogar, opções, sair...etc)
	Graphics bbg; // como nos outros métodos da classe game.java usamos essa varialvel para
					// desenhar elementos na tela
	boolean ativo; // indica se o menu está ativo ou não (ao inicar o jogo desativamos o menu, para
					// o controlemos durante o jogo)
	...
	// isso é o construtor ao criarmos o objeto do tipo Menu, teremos que informar o
	// número de itens as coordenadas e se ele estará ativo ou não!
